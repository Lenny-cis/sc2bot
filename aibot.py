# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 21:44:35 2019
...
class SentdeBot(sc2.BotAI):
    ...
    async def expand(self):
        if self.units(NEXUS).amount <\
                ((self.iteration / self.ITERATIONS_PER_MINUTE)/2) and\
    ...
    def find_target(self, state):
        if self.known_enemy_units.amount > 0:
            ...
            return random.choice(self.know_enemy_structures)
        else:
...
run_game(maps.get("AscensiontoAiurLE"), [
